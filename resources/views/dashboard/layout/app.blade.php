...
>>>>>>> 5b3fc751280805dc8db452042ff5969fa1bf23d4
                    </a>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="/" class="brand-link">
                ...
                <span class="brand-text font-weight-light"
                    style="text-transform: uppercase;">{{ config('app.name') }}</span>
            </a>
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview"
                        ...
                        <li class="nav-item ">
                            <a href="#" class="d-block nav-link">
                                ...
                                <img src="{{ $usdt->profilepic }}" class="img-circle elevation-2" alt="User Image"
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item has-treeview">
                            <a href="#" class="nav-link">
                                ...
                                <i class="fab fa-product-hunt nav-icon" aria-hidden="true"></i>
                                <p>
                                    Products
                                    <i class="fas fa-angle-left right"></i>
                                </p>
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                 <li class="nav-item">
                                    <a href="add-service-man" class="nav-link">
                                        <i class="fa fa-plus nav-icon" aria-hidden="true"></i>
                                        <p>Add Service man</p>
                                    </a>
                                </li>
    ...
    <div class="col-md-4">
        ...
        <div class="card card-widget widget-user">
            ...
            <div class="widget-user-header bg-info"
                style="background: url('dashboard/dist/img/photo1.png') center center;">
